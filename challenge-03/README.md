...
*/
var pessoa = { nome: 'Fernando', sobrenome: 'Nascimento', sexo: 'Masculino', idade: 33, altura: 1.90, peso: 95, andando: false, caminhouQuantosMetros: 0 };
...
*/
pessoa.nomeCompleto();  // 'Olá! Meu nome é Fernando Nascimento!' //
